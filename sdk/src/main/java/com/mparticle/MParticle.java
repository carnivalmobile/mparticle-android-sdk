...
public class MParticle {
        ...
        if (instance == null) {
            synchronized (MParticle.class) {
                if (instance == null) {
                    ...
                    kitManager.setAppStateManager(appStateManager);
                    configManager.setKitManager(kitManager);
                    appStateManager.setKitManager(kitManager);
                    ...
                    kitManager.setReportingManager((ReportingManager) instance.mMessageManager);
    ...
    public Uri getSurveyUrl(int serviceProviderId) {
        return mKitManager.getSurveyUrl(serviceProviderId, mUserAttributes);
    }
